...
export const ui = {
  es: {
    ...
    "offer.steppedDiscount": (first: string, second: string) => `${first} de descuento en la 1ª unidad, ${second} de descuento en la 2ª unidad.`,
    "offer.steppedDiscount3": (first: string, second: string, third: string) => `${first} de descuento en la 1ª unidad, ${second} de descuento en la 2ª unidad, ${third} de descuento en la 3ª unidad.`,
    "offer.1u15pct2u40pct": "15% en la 1ª unidad o 40% en la 2ª unidad. No acumulables.",
    "offer.xein1udOrYein2ud": (x: string, y: string) => `${x}€ de descuento en 1 unidad o ${y}€ de descuento en 2 unidades.`,
  ...
  en: {
    ...
    "offer.steppedDiscount": (first: string, second: string) => `${first} off on 1st unit, ${second} off on 2nd unit.`,
    "offer.steppedDiscount3": (first: string, second: string, third: string) => `${first} off on 1st unit, ${second} off on 2nd unit, ${third} off on 3rd unit.`,
    "offer.1u15pct2u40pct": "15% off 1st unit or 40% off 2nd unit. Not combinable.",
    "offer.xein1udOrYein2ud": (x: string, y: string) => `€${x} off on 1 unit or €${y} off on 2 units.`,
