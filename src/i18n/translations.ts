...
export const ui = {
  es: {
    ...
    "offer.steppedDiscount": (first: string, second: string) => `${first} en la 1ª unidad, ${second} en la 2ª unidad.`,
    "offer.steppedDiscount3": (first: string, second: string, third: string) => `${first} en la 1ª unidad, ${second} en la 2ª unidad, ${third} en la 3ª unidad.`,
  ...
  en: {
    ...
    "offer.steppedDiscount": (first: string, second: string) => `${first} on 1st unit, ${second} on 2nd unit.`,
    "offer.steppedDiscount3": (first: string, second: string, third: string) => `${first} on 1st unit, ${second} on 2nd unit, ${third} on 3rd unit.`,
